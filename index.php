    ...
    if(isset($_POST['btn_login'])){
        ...
        if(is_array($row)){
            ...
            if($row['username']==$username AND $row['password']==$password AND $row['role']=='admin'){
                ...
                echo $notif = "<div class=\"alert alert-success coll-md-12\"style=\"max width:24%; flex:unset\">Berhasil Login </div>";
            ...
            //check if role operator
                ...
                echo $notif = "<div class=\"alert alert-danger coll-md-12\"style=\"max width:24%; flex:unset\">Berhasil Login </div>";
                header('refresh: 1;view/dashboard/operator_dashboard.php');
            }else{
            echo $notif = "<div class=\"alert alert-danger coll-md-12\" style=\"max-width:24%; flex:unset\">Username / Password Salah </div>";
            }
        }
    }
?>
